...
import { Loader2, TrendingUp, TrendingDown, Minus, BarChart2, ArrowLeft, Calendar, ChevronRight, ChevronDown, Activity } from "lucide-react";
      ...
      <div className="grid grid-cols-2 gap-3 mb-5">
        <div className="border border-white/10 rounded-2xl bg-white/5 p-3.5">
          ...
          <div className="flex items-center gap-2">
            <AngularDumbbell className="w-5 h-5 text-primary" />
